  ...
  return (
    <section className="bg-background border-t border-border-subtle overflow-hidden">
      <div className="flex flex-col md:flex-row min-h-[600px]">
        {/* LEFT: TAL (Core Lab) */}
        <div className="flex-1 p-10 md:p-20 border-b md:border-b-0 md:border-r border-border-subtle flex flex-col justify-center">
          <AnimateOnScroll>
        ...
        {/* RIGHT: TAL VI */}
        <div className="flex-1 p-10 md:p-20 bg-bg-secondary flex flex-col justify-center">
